...
public class ModelZombieSpearer extends ModelBiped
{
	...
	public ModelZombieSpearer()
	{
		this(0.0F);
	}

	public ModelZombieSpearer(float par1)
	{
	 ...
	 */
	 public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity)
	 {
		 ...
		 this.bar.rotateAngleX=this.bipedRightArm.rotateAngleX;
		 this.socket1.rotateAngleX=this.bipedRightArm.rotateAngleX;
		 this.socket2.rotateAngleX=this.bipedRightArm.rotateAngleX;
		 this.spike1.rotateAngleX=this.bipedRightArm.rotateAngleX;
		 this.spike2.rotateAngleX=this.bipedRightArm.rotateAngleX;

		 this.bamboo_bar.rotateAngleX=this.bipedRightArm.rotateAngleX;
		 this.point1A.rotateAngleX=this.bipedRightArm.rotateAngleX;
		 this.point1B.rotateAngleX=this.bipedRightArm.rotateAngleX;
		 this.point2A.rotateAngleX=this.bipedRightArm.rotateAngleX;
		 this.point2B.rotateAngleX=this.bipedRightArm.rotateAngleX;
		 this.point3.rotateAngleX=this.bipedRightArm.rotateAngleX;
		 this.point4.rotateAngleX=this.bipedRightArm.rotateAngleX;
	 }
